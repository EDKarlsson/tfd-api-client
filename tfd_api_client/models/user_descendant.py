...
class UserDescendant(BaseModel):
    ...
    customizing: Optional[List[UserDescendantCustomizingInner]] = Field(default=None, description="Customization information")
    __properties: ClassVar[List[str]] = ["ouid", "user_name", "descendant_id", "descendant_slot_id", "descendant_level", "module_max_capacity", "module_capacity", "energy_activator_use_count", "module", "customizing"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.module:
            ...
            _dict['module'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in customizing (list)
        _items = []
        if self.customizing:
            for _item_customizing in self.customizing:
                if _item_customizing:
                    _items.append(_item_customizing.to_dict())
            _dict['customizing'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customizing": [UserDescendantCustomizingInner.from_dict(_item) for _item in obj["customizing"]] if obj.get("customizing") is not None else None
        })
        return _obj
