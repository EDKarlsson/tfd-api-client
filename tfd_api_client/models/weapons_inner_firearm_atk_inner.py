...
class WeaponsInnerFirearmAtkInner(BaseModel):
    """
    WeaponsInnerFirearmAtkInner
    """ # noqa: E501
    level: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Firearm level")
    firearm: Optional[List[WeaponsInnerFirearmAtkInnerFirearmInner]] = Field(default=None, description="Firearm ATK")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.firearm:
            for _item_firearm in self.firearm:
                if _item_firearm:
                    _items.append(_item_firearm.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "level": obj.get("level"),
            "firearm": [WeaponsInnerFirearmAtkInnerFirearmInner.from_dict(_item) for _item in obj["firearm"]] if obj.get("firearm") is not None else None
        })
        return _obj
