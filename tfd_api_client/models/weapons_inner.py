...
class WeaponsInner(BaseModel):
    ...
    weapon_tier_id: Optional[StrictStr] = Field(default=None, description="Weapon tier (Refer to /meta/tier API)")
    weapon_rounds_type: Optional[StrictStr] = Field(default=None, description="Weapon rounds type")
    available_core_slot: Optional[List[StrictStr]] = Field(default=None, description="List of unlockable core slots (Refer to the /meta/core-slot API)")
    base_stat: Optional[List[WeaponsInnerBaseStatInner]] = Field(default=None, description="Weapon base spec information")
    firearm_atk: Optional[List[WeaponsInnerFirearmAtkInner]] = Field(default=None, description="Firearm attack power by level information")
    ...
    __properties: ClassVar[List[str]] = ["weapon_name", "weapon_id", "image_url", "weapon_type", "weapon_tier_id", "weapon_rounds_type", "available_core_slot", "base_stat", "firearm_atk", "weapon_perk_ability_name", "weapon_perk_ability_description", "weapon_perk_ability_image_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.firearm_atk:
            for _item_firearm_atk in self.firearm_atk:
                if _item_firearm_atk:
                    _items.append(_item_firearm_atk.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "weapon_tier_id": obj.get("weapon_tier_id"),
            "weapon_rounds_type": obj.get("weapon_rounds_type"),
            "available_core_slot": obj.get("available_core_slot"),
            "base_stat": [WeaponsInnerBaseStatInner.from_dict(_item) for _item in obj["base_stat"]] if obj.get("base_stat") is not None else None,
            "firearm_atk": [WeaponsInnerFirearmAtkInner.from_dict(_item) for _item in obj["firearm_atk"]] if obj.get("firearm_atk") is not None else None,
