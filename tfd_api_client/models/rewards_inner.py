...
class RewardsInner(BaseModel):
    ...
    battle_zone: Optional[List[RewardsInnerBattleZoneInner]] = Field(default=None, description="Battlefield information")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.battle_zone:
            for _item_battle_zone in self.battle_zone:
                if _item_battle_zone:
                    _items.append(_item_battle_zone.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "battle_zone": [RewardsInnerBattleZoneInner.from_dict(_item) for _item in obj["battle_zone"]] if obj.get("battle_zone") is not None else None
        })
        return _obj
