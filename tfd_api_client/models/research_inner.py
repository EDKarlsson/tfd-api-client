...
class ResearchInner(BaseModel):
    ...
    research_cost: Optional[List[ResearchInnerResearchCostInner]] = Field(default=None, description="Research cost")
    research_boost_cost: Optional[List[ResearchInnerResearchCostInner]] = Field(default=None, description="Boost Research Cost")
    research_result: Optional[List[ResearchInnerResearchResultInner]] = Field(default=None, description="Research result")
    research_material: Optional[List[ResearchInnerResearchMaterialInner]] = Field(default=None, description="Research materials")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "research_cost": [ResearchInnerResearchCostInner.from_dict(_item) for _item in obj["research_cost"]] if obj.get("research_cost") is not None else None,
            "research_boost_cost": [ResearchInnerResearchCostInner.from_dict(_item) for _item in obj["research_boost_cost"]] if obj.get("research_boost_cost") is not None else None,
            "research_result": [ResearchInnerResearchResultInner.from_dict(_item) for _item in obj["research_result"]] if obj.get("research_result") is not None else None,
            "research_material": [ResearchInnerResearchMaterialInner.from_dict(_item) for _item in obj["research_material"]] if obj.get("research_material") is not None else None
        })
        return _obj
