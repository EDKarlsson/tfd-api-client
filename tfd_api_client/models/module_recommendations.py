...
class ModuleRecommendations(BaseModel):
    ...
    """ # noqa: E501
    descendant: Optional[ModuleRecommendationsDescendant] = None
    weapon: Optional[ModuleRecommendationsWeapon] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "descendant": ModuleRecommendationsDescendant.from_dict(obj["descendant"]) if obj.get("descendant") is not None else None,
            "weapon": ModuleRecommendationsWeapon.from_dict(obj["weapon"]) if obj.get("weapon") is not None else None
        })
        return _obj
