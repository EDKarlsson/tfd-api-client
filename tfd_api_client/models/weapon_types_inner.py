...
class WeaponTypesInner(BaseModel):
    """
    WeaponTypesInner
    """ # noqa: E501
    weapon_type: Optional[StrictStr] = Field(default=None, description="Weapon type")
    weapon_type_name: Optional[StrictStr] = Field(default=None, description="Weapon type name")
    __properties: ClassVar[List[str]] = ["weapon_type", "weapon_type_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "weapon_type_name": obj.get("weapon_type_name")
        })
        return _obj
