...
class TestUserArcheTuning(unittest.TestCase):
    """UserArcheTuning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserArcheTuning:
        """Test UserArcheTuning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserArcheTuning`
        """
        model = UserArcheTuning()
        if include_optional:
            return UserArcheTuning(
                ouid = '',
                descendant_group_id = '',
                arche_tuning_board_group_id = '',
                arche_tuning = [
                    tfd_api_client.models.user_arche_tuning_arche_tuning_inner.UserArcheTuning_arche_tuning_inner(
                        slot_id = '', 
                        arche_tuning_board = [
