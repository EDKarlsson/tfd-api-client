    ...
    def make_instance(self, include_optional) -> FellowResponseInner:
        ...
        if include_optional:
            return FellowResponseInner(
                ...
                fellow_tier_id = '',
                fellow_detail = [
                    tfd_api_client.models.fellow_response_inner_fellow_detail_inner.FellowResponse_inner_fellow_detail_inner(
                        fellow_level = 1.337, 
                        search_radius_value = 1.337, 
                        stat_effect = [
                            tfd_api_client.models.fellow_response_inner_fellow_detail_inner_stat_effect_inner.FellowResponse_inner_fellow_detail_inner_stat_effect_inner(
                                stat_id = '', 
                                stat_value = 1.337, )
                            ], )
                    ]
